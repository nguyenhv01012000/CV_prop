        ...
        >
          <div className="grid grid-cols-2 gap-8">
            <Input
              ...
              placeholder={t('shared.forms.namePlaceholder')}
              {...getFieldProps(formik, schema, 'name')}
            />

            <Input
              label={t('shared.forms.position')}
              placeholder={t('shared.forms.positionPlaceholder')}
              {...getFieldProps(formik, schema, 'position')}
            />

            <Input
              label={t('shared.forms.phone')}
              placeholder={t('shared.forms.phonePlaceholder')}
              {...getFieldProps(formik, schema, 'phone')}
            />

            <Input
              label={t('shared.forms.email')}
              placeholder={t('shared.forms.emailPlaceholder')}
